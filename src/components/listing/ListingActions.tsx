    ...
    return (
      <div className="space-y-3">
        ...
        <button 
          ...
          className="w-full bg-accent text-accent-foreground py-5 rounded-[24px] font-black uppercase italic text-xl hover:bg-accent/80 transition-all active:scale-95"
        >
          Manage Listing
        </button>
      </div>
